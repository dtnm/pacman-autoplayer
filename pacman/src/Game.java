...
//  filePath is just a single xml file: test3.xml for instance
  public Game(GameCallback gameCallback, String filePath, PortalDict protals)
  {
    //Setup game
    super(nbHorzCells, nbVertCells, 20, false);
    grid = new PacManGameGrid(filePath, protals);
//    load the properties file here
    final Properties properties = PropertiesLoader.loadPropertiesFile("properties/test" + filePath.substring(0, filePath.length()-4) + ".properties");
