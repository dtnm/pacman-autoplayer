...
import src.IReadingFile;
import src.ReadingFileFactory;
...
public class Controller implements ActionListener, GUIInformation {
	...
	private IReadingFile fileReader;
	...
	public Controller(String fileMap, String fileType){
		init(Constants.MAP_WIDTH, Constants.MAP_HEIGHT);

		fileReader = ReadingFileFactory.getInstance().getFileAdapter(fileType);
//		loadFileMap(fileMap);

		fileReader.loadFileMap(fileMap, this);
	}
	...
	public void loadFileMap(String fileMap){
		SAXBuilder builder = new SAXBuilder();
		try {
